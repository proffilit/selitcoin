...
uint256 hashGenesisBlock("0x2b0152de66d46ceb04fdf1ec7982069815f0e218992ef5bb9bc745fcd32ef0a7");
...
const string strMessageMagic = "SelitCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Selitcoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Selitcoin: 2.5 minutes
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal selitcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SelitCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8b62c47d92e9c4a1ad84c4987d7911e51eecfa6782bd3fe8f080ed846428e7d2");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "BBC News 12-06-2016 E3 2016 Gaming extravaganza boots up in LA";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1465737900; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 431163;

        if (fTestNet)
        {
            block.nTime    = 1465737830;
            block.nNonce   = 60583;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb9d4b31d827a46611331145515f046f1e19c19cc3a9af67920c4bb1cb635fd29"));
